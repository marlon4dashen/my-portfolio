            ...
            <section className="bg-gray-700">
                ...
                <div className="grid grid-cols-4 pt-5 mx-60 pb-60 items-start">
                    ...
                    <div className="flex flex-col justify-center pt-6 w-48">
                        ...
                        <h6 className="flex justify-center text-white font-serif pt-5"> One fact is that I've been to almost every part of the China. Internationally, I've never been to another continent besides Asia and North America. </h6>
                    </div>
                    <div className="flex flex-col justify-center pt-6 w-48">
